...
</div>
{
    role =="ADMIN" || data?.subscription?.status == "ACTIVE" ? (
        <button  className='bg-yellow-600 text-xl rounded-md font-bold px-3 w-full hover:bg-yellow-500 transition-all ease-in-out duration-300 '>Watch Lectures</button>
    ):(
